...
|------|-------------|-------------|------------------|---------|
| **默认模式** | INBOUND | OUTBOUND | 货架位 1 → 线 A<br/>货架位 2 → 线 B | 入库/出库均衡 |
| **双入库模式** | INBOUND | INBOUND | 货架位 1 → 线 A<br/>货架位 2 → 线 B | 入库高峰期 |
| **双出库模式** | OUTBOUND | OUTBOUND | 货架位 1 → 线 A<br/>货架位 2 → 线 B | 出库高峰期 |
