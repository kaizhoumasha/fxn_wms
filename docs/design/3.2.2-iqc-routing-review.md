...
> **版本**: v1.1
> **修订日期**: 2025-12-25
> **修订内容**: 补充审计追踪与异常管理模型 (qms_api_log, iqc_exception_log, pallet_status_history_iqc)，增强外键约束
...
**职责说明**: 当前阶段由 WMS 全权负责 IQC 动态路由与复判流程（包括业务逻辑、决策引擎、任务创建、RCS调度），RCS 仅负责 AGV 搬运执行与地码同步。
